...
{
    public partial class ucPlanTree : BaseControl
    {
        ...
        void InitData()
        {
            TreeListNode tlPlan = treeList1.AppendNode(new object[] { Properties.Resources.PlanManage, MailType.Inbox, MailFolder.Announcements, 5 }, null);
            treeList1.AppendNode(new object[] { Properties.Resources.Plan, MailType.Inbox, MailFolder.Announcements }, tlPlan);
