...
{
    public partial class ucDeviceTree : BaseControl
    {
        ...
        void InitData()
        {
            TreeListNode tlDevice = treeList1.AppendNode(new object[] { Properties.Resources.DeviceManage, MailType.Inbox, MailFolder.Announcements, 5 }, null);
            treeList1.AppendNode(new object[] { Properties.Resources.Terminal, MailType.Inbox, MailFolder.Announcements }, tlDevice);
            treeList1.AppendNode(new object[] { Properties.Resources.PLC, MailType.Sent, MailFolder.Announcements, 1 }, tlDevice);
            treeList1.AppendNode(new object[] { Properties.Resources.AVG, MailType.Draft, MailFolder.Announcements, 2 }, tlDevice);
            treeList1.AppendNode(new object[] { Properties.Resources.RFID, MailType.Sent, MailFolder.Announcements, 3 }, tlDevice);
        ...
        void CreateMessagesForNode(TreeListNode node)
        {
            ...
            foreach (User message in DataHelper.User)
            {
        ...
        //int GetUnreadMessagesCount(List<User> list)
        //{
