...
{
    public partial class ucReportTree : BaseControl
    {
        ...
        void InitData()
        {
            TreeListNode tlReport = treeList1.AppendNode(new object[] { Properties.Resources.ReportManage, MailType.Inbox, MailFolder.Announcements, 5 }, null);
            treeList1.AppendNode(new object[] { Properties.Resources.Report, MailType.Inbox, MailFolder.Announcements }, tlReport);
