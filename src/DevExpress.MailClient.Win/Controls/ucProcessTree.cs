...
{
    public partial class ucProcessTree : BaseControl
    {
public event DataSourceChangedEventHandler DataSourceChanged;
        ...
        void InitData()
        {
            TreeListNode tlProcess = treeList1.AppendNode(new object[] { Properties.Resources.ProcessManage, MailType.Inbox, MailFolder.Announcements, 5 }, null);
            treeList1.AppendNode(new object[] { Properties.Resources.Process, MailType.Inbox, MailFolder.Announcements }, tlProcess);
