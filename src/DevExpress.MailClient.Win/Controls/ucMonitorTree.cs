...
{
    public partial class ucMonitorTree : BaseControl
    {
       public event DataSourceChangedEventHandler DataSourceChanged;
        ...
        void InitData()
        {
            TreeListNode tlMonitor = treeList1.AppendNode(new object[] { Properties.Resources.MonitorManage, MailType.Inbox, MailFolder.Announcements, 5 }, null);
            treeList1.AppendNode(new object[] { Properties.Resources.LineMonitor, MailType.Inbox, MailFolder.Announcements }, tlMonitor);
            treeList1.AppendNode(new object[] { Properties.Resources.PlanMonitor, MailType.Sent, MailFolder.Announcements, 1 }, tlMonitor);
            treeList1.AppendNode(new object[] { Properties.Resources.ProductMonitor, MailType.Draft, MailFolder.Announcements, 2 }, tlMonitor);
            //treeList1.AppendNode(new object[] { Properties.Resources.DeptManage, MailType.Sent, MailFolder.All, 2 }, tlSystem);
