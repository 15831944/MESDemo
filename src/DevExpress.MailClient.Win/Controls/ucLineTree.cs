...
{
    public partial class ucLineTree : BaseControl
    {
        ...
        void InitData()
        {
            TreeListNode tlLine = treeList1.AppendNode(new object[] { Properties.Resources.LineManage, MailType.Inbox, MailFolder.Announcements, 5 }, null);
            TreeListNode tlLineParent = treeList1.AppendNode(new object[] { Properties.Resources.Line, MailType.Inbox, MailFolder.All }, tlLine);
            //TreeListNode tlLineChild = treeList1.AppendNode(new object[] { Properties.Resources.Station, MailType.Inbox, MailFolder.All, 4 }, tlLineParent);

            treeList1.AppendNode(new object[] { Properties.Resources.Station, MailType.Inbox, MailFolder.Announcements }, tlLineParent);
            //treeList1.AppendNode(new object[] { Properties.Resources.RoleManage, MailType.Draft, MailFolder.Announcements, 2 }, tlLine);
            //treeList1.AppendNode(new object[] { Properties.Resources.DeptManage, MailType.Sent, MailFolder.All, 2 }, tlLine);
